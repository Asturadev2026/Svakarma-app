...
const applicationsStorage = new Map();
...
router.get('/applications', auth_middleware_1.authMiddleware, (req, res) => {
...
router.post('/apply', auth_middleware_1.authMiddleware, (req, res) => {
    const userId = req.userId || 'default_user';
